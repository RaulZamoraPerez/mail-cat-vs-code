...
export function activate(context: vscode.ExtensionContext) {
  console.log('MailCat Sandbox activado');
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("rzp-mail-sandbox.stop", async () => {
      try {
        ...
        updateStatusBar();
        vscode.window.showInformationMessage("MailCat Sandbox detenido");
      } catch (error) {
        vscode.window.showErrorMessage(
...
auth: {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("rzp-mail-sandbox.generateEnv", async () => {
      ...
      const envContent = `# MailCat Sandbox Configuration
# Generated by MailCat Sandbox Extension
